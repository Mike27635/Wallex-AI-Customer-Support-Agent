...
st.set_page_config(page_title="Wallex AI Customer Support Agent", page_icon="🤖", layout="wide")
...
WALLEX_KEYWORDS = ["wallex", "kyc", "deposit", "withdrawal", "wallet", "transaction", "txid", "crypto", "pending", "verification", "email"]
...
Always be: Professional, Friendly, Empathetic, Clear, Honest.
...
st.write("Ask a question about your Wallex account (deposits, KYC, transactions) or anything else — I'll route it to the right source automatically.")
...
if user_question:
    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            answer, route = ai_customer_support_agent(user_question, retriever, llm, search_tool, st.session_state.chat_history)
            st.markdown(answer)
